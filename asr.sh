...
lm_config=conf/tuning/test/train_asr_conformer_test.yaml        # Config for language model training.
...
asr_config=conf/tuning/test/train_asr_conformer_test.yaml    # Config for asr model training.
...
inference_config=conf/decode_asr_branchformer.yaml # Config for decoding.
